...
export default function TopFilterBar({
  ...
  const bedLabel =
    filters.bedrooms && filters.maxBedrooms
      ? `${filters.bedrooms}–${filters.maxBedrooms} Beds`
      : filters.bedrooms
      ? `${filters.bedrooms}+ Beds`
      : filters.maxBedrooms
      ? `≤${filters.maxBedrooms} Beds`
      : "Bedroom";
  ...
  return (
    <>
      ...
      >
        ...
        <button
          onClick={onReset}
          className={`flex items-center gap-1.5 px-4 py-3 text-sm font-medium transition-colors rounded-full whitespace-nowrap ${
            hasActiveFilters
      ...
      <FilterDropdownPortal isOpen={showFilters === "bedroom"}>
        ...
        >
          <div
            className="filter-dropdown bg-white border border-gray-200 rounded-xl shadow-xl p-6 w-80"
          ...
          >
            ...
            <div className="mb-6">
              <DualStepSlider
                ...
                onMinChange={(v) =>
                  setFilters({ ...filters, bedrooms: v === "0" ? "" : v })
                }
                onMaxChange={(v) =>
                  setFilters({ ...filters, maxBedrooms: v === "5" ? "" : v })
                }
                onSnapTo={(v) =>
                  setFilters({
                    ...filters,
            ...
            <div className="flex justify-between">
              <button
                onClick={() =>
                  setFilters({ ...filters, bedrooms: "", maxBedrooms: "" })
                }
          ...
          >
            ...
            <div className="mb-6">
              <DualStepSlider
                ...
                onMinChange={(v) =>
                  setFilters({ ...filters, bathrooms: v === "1" ? "" : v })
                }
                onMaxChange={(v) =>
                  setFilters({ ...filters, maxBathrooms: v === "4" ? "" : v })
                }
                onSnapTo={(v) =>
                  setFilters({
                    ...filters,
            ...
            <div className="flex justify-between">
              <button
                onClick={() =>
                  setFilters({ ...filters, bathrooms: "", maxBathrooms: "" })
                }
                className="text-red-600 hover:bg-red-50 px-4 py-2 rounded-lg text-sm"
              >
                Reset
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setDraft({ ...draft, moveInDate: e.target.value })
                      }
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <DualStepSlider
                      ...
                      onMinChange={(v) =>
                        setDraft({ ...draft, bedrooms: v === "0" ? "" : v })
                      }
                      onMaxChange={(v) =>
                        setDraft({ ...draft, maxBedrooms: v === "5" ? "" : v })
                      }
                      onSnapTo={(v) =>
                        setDraft({
                          ...draft,
                  ...
                  <div>
                    ...
                    <DualStepSlider
                      ...
                      onMinChange={(v) =>
                        setDraft({ ...draft, bathrooms: v === "1" ? "" : v })
                      }
                      onMaxChange={(v) =>
                        setDraft({ ...draft, maxBathrooms: v === "4" ? "" : v })
                      }
                      onSnapTo={(v) =>
                        setDraft({
                          ...draft,
                  ...
                  <div>
                    ...
                    <StepSlider
                      ...
                      onChange={(v) =>
                        setDraft({ ...draft, distanceToShuttle: v })
                      }
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        onChange={(e) =>
                          setDraft({ ...draft, furnished: e.target.value })
                        }
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        onChange={(e) =>
                          setDraft({ ...draft, leaseStructure: e.target.value })
                        }
                        className="w-full appearance-none px-3 py-2 pr-8 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-red-500 focus:border-red-500 bg-white"
                      >
                        <option value="">Any</option>
                      ...
                      >
                        ...
                        <button
                          ...
                          className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                            draft[field] ? "bg-red-500" : "bg-gray-200"
                          }`}
                        >
                          <span
