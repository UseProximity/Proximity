...
const COMPONENT_DESCRIPTIONS = {
  ...
  "chat/ChatAvatar.js": "Avatar with photo or initials fallback for chat list/transcript",
  ...
  "chat/ChatWidget.js": "Messenger panel (compact + expanded under nav); opened via openMessages / header badge",
  "chat/chatEvents.js": "openMessages() CustomEvent bridge to open ChatWidget from anywhere",
