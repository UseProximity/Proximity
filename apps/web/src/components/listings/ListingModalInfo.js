        ...
        >
          ...
          >
            ...
            <div className="bg-white rounded-xl shadow px-6 py-5 mb-4 flex flex-col md:flex-row md:justify-between md:items-center gap-4">
              ...
              <div className="shrink-0 w-full md:w-auto flex flex-row items-center gap-2 md:ml-auto">
                <button
                  type="button"
                  ...
                  className={`shrink-0 w-9 h-9 inline-flex items-center justify-center rounded-lg border shadow-sm transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2 active:translate-y-[1px] ${
                    listing.unavailable
                ...
                {!listing.furnished && (
                  <a
                    ...
                    className="flex-1 sm:flex-none sm:w-[170px] h-9 inline-flex items-center justify-center text-xs font-semibold rounded-lg bg-red-50 text-red-700 border border-red-200 shadow-sm hover:bg-red-100 hover:border-red-300 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2 active:translate-y-[1px]"
                  >
